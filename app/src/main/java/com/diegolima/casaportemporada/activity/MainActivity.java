...
import com.diegolima.casaportemporada.activity.autenticacao.LoginActivity;
import com.diegolima.casaportemporada.adapter.AdapterAnuncios;
import com.diegolima.casaportemporada.helper.FirebaseHelper;
import com.diegolima.casaportemporada.model.Anuncio;
import com.diegolima.casaportemporada.model.Filtro;
...
public class MainActivity extends AppCompatActivity implements AdapterAnuncios.OnClick {
    ...
    private void recuperarAnuncios() {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) { //se existe alguma informação no banco de dados do Firebase
                    anuncioList.clear();
    ...
    private void recuperarAnunciosFiltros() {
        DatabaseReference reference = FirebaseHelper.getDatabaseReference()
                .child("anuncios_publicos");
    ...
    private void showDialogLogin() {
        ...
        builder.setNegativeButton("Não", (dialog, whitch) -> dialog.dismiss());
        builder.setPositiveButton("Sim", (dialog, whitch) -> {
    ...
    public void OnClickListener(Anuncio anuncio) {
        Intent intent = new Intent(this, DetalheAnunciosActivity.class);
