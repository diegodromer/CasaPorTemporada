package com.diegolima.casaportemporada.adapter;
...
public class AdapterAnuncios extends RecyclerView.Adapter<AdapterAnuncios.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        //getUrl -> é de onde a gente vai buscar a imagem
        //into -> é onde vai ser carregada a imagem que foi buscada
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            text_titulo = itemView.findViewById(R.id.text_titulo_tootbar);
